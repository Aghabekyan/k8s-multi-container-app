  docker build -t aghabekyan374/multi-client:latest -t aghabekyan374/multi-client:$SHA ./client/Dockerfile ./client
  docker build -t aghabekyan374/multi-server:latest -t aghabekyan374/multi-server:$SHA ./server/Dockerfile ./server
  docker build -t aghabekyan374/multi-worker:latest -t aghabekyan374/multi-worker:$SHA ./worker/Dockerfile ./worker
